...
(parallel + batched shapes for implement, single-pass with
a skipped fixer on a clean review, pass-verdict early exit + cross-round skip accumulation
for simplify); the three SKILL.md call layers invoke `run_workflow('<name>', args)` and no
...
| ------------------------------------------------- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [uniterra-plan](#uniterra-plan)                   | Plan a feature/task (prd/design/plan/規劃/計畫)                                     | Clarify requirements + design interactively → scaffold the run dir (init_plan.mjs) → fill prd.md / design.md / acceptance.md → confirm the plan with the user                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
3. **Confirm with the user** — read the three docs back with a short summary and ask via `ask_user_question` whether the content is broadly correct and matches their needs; apply any edits they raise and show the result again.
