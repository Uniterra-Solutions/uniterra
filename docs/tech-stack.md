...
| ------------------------------------- | ------- | -------------------------------------------------------------- |
| @uniterra-solutions/uniterra-desktop  | 0.17.0  | Electron shell over the bundled dsh CLI; built-in provisioning |
| @uniterra-solutions/uniterra          | 0.17.0  | Public npm installer CLI (bin `uniterra`)                      |
