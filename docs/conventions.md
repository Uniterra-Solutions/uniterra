...
| Review regression tests are permanent                   | `uniterra-review`'s review agent pins each invariant with a property-based test in the repo's existing test + property-testing stack and conventional test location (descriptive, invariant-based name, never a finding id); it reports only counterexamples it confirmed (red). The fix agent turns them green but never deletes or renames them                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
