...
/**
 * TEMPORARY COMPATIBILITY ALIAS (uniterra divergence, see vendor/dsh-harness/VENDOR.md):
 * the 0.1.2-rc.1 family renamed this brand to ToolCallId, but the community
 * plugin ecosystem (dsh-better-sidebar, dsh-file-upload, dsh-git-worktree, ...) still
 * imports CallId; re-exporting the renamed value keeps those plugins loadable until
 * upstream re-releases them against the renamed surface. Remove with the divergence.
 */
