...
// TEMPORARY COMPATIBILITY ALIASES (uniterra divergence, see vendor/dsh-harness/VENDOR.md):
// isJsonValue / snapshotJsonValue moved to @deepseek-ai/dsh-util-values in the 0.1.2-rc.1
// family, but the removed @deepseek-ai/dsh-llm-style ecosystem still imports them from
// dsh-session (e.g. the old dsh-tools@0.1.1-rc.2 copy dsh-computer-use@0.2.0 pins). Re-export
// the moved values until those packages are re-released against the new family.
