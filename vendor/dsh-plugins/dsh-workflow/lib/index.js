...
function resolveConfig(config) {
    return {
        ...
        modelTiers: {
            fast: tier(config.fastProvider ?? 'spawn', config.fastModelProvider ?? '', config.fastModel ?? '', config.fastMaxTokens ?? 384_000),
            balanced: tier(config.balancedProvider ?? 'spawn', config.balancedModelProvider ?? '', config.balancedModel ?? '', config.balancedMaxTokens ?? 384_000),
            deep: tier(config.deepProvider ?? 'spawn', config.deepModelProvider ?? '', config.deepModel ?? '', config.deepMaxTokens ?? 384_000),
        },
